...
OBJS = main.o init.o boot.elf kprint.o lib.o paging.o idt.o gdt.o keyboard.o gdt.elf idt.elf irq.o pic.elf exceptions.o ring3.elf keyboard.elf paging.elf
