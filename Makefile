...
mel.elf : main.o kprint.o lib.o gdt.o idt.o keyboard.o paging.o gdt_s.elf idt_s.elf irq.o exceptions.o ring3.elf keyboard_s.elf paging_s.elf pic.elf linker.ld boot.elf
	ld -m elf_i386 -T linker.ld main.o boot.elf kprint.o lib.o paging.o idt.o gdt.o keyboard.o gdt_s.elf idt_s.elf irq.o pic.elf exceptions.o ring3.elf keyboard_s.elf paging_s.elf -o mel.elf
main.o : main.c
	gcc $(CCFLAGS) main.c
lib.o : lib/lib.c
